...
const MySoldProperties = () => {
    ...
    const soldProperties = loadedOfferedProperties.filter(item => item.status === "bought")
            ...
            <div className="overflow-x-auto md:min-h-[200px]">
                <table className="table">
                    ...
                    <tbody>
                        {/* row 1 */}
                        {
                            soldProperties.map(prop=><RequestedPropCard key={prop._id} prop={prop}></RequestedPropCard>)
                        }
                    </tbody>
